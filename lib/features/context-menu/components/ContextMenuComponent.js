  ...
  onClick(id) {
    ...
    const listener = ({ target }) => {
      ...
      if (this.state.id === id) {
        ...
        // instead of checking wether this.node contains target we check the other way around
        // in some cases target might have been deleted, therefore this.node would not contain it anymore
        if (context.closeOnClick !== false && target.contains(this.node)) {
